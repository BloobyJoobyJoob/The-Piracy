...
{
    public static MeshData GenerateTerrainMesh(float[,] heightMap, TerrainType[] regions, float heightMultiplier, AnimationCurve heightCurve)
    {
...
public class MeshData
{
    ...
    public MeshData(int meshWidth, int meshHeight, int verticesPerSquare)
    {
        ...
        triangles = new int[(meshWidth - 1) * (meshHeight - 1) * verticesPerSquare];
    }
